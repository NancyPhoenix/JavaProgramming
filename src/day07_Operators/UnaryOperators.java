...
public class UnaryOperators {
    ...
    public static void main(String[] args) {
       ...
       int num2=-25;
        ...
        int c=100;
        System.out.println(c++);//post increment:first passes the current value ,increases the value by 1 left away
        ...
        int y=200;
        System.out.println(y--);//post decrement:first passes the current value ,increases the value by 1 left away

        int z=45;

        System.out.println(++z);//46, z=46 pre
        System.out.println(z++);//47,z=47  post
        System.out.println(z);//47


        int q=30;
        System.out.println(--q);//29, q=29 pre
